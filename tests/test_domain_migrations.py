...
def test_schema_has_exactly_one_revision():
    """One autogenerated baseline is the whole history.
    ...
    copy still declared. They drifted. The ORM is now the only source and the
